class Television{
static String brand[]={"Sony","Samsung}","LG","Mi","OnePlus","Panasonic","TCL","Philips","Sharp","Haier","Tonhiba","Motorola","mi","Vu","Realme"};
	static long modelNumber[]={8023345, 4587578, 739771, 267648, 6779150, 7883476, 5878802, 6990914, 8788233, 124675, 657321, 987654, 123456, 789098, 678543};
